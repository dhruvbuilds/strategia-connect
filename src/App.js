...
const allowlist = [
  ...
  const Landing = () => (
    <div className="page">
      <nav className="nav"><img src={STRATEGIA_LOGO} alt="STRATEGIA" className="nav-logo" /><button className="btn-ghost" onClick={() => setView('login')}>Sign In</button></nav>
      <main className="hero">
  ...
  const App = () => {
    ...
    return (
      <div className="page app-page">
        <nav className="app-nav"><img src={STRATEGIA_LOGO} alt="STRATEGIA" className="nav-logo sm" /><button className="btn-ghost sm" onClick={handleLogout}>Exit</button></nav>
